        ...
        <Card className="overflow-hidden py-0">
          <CardContent className="grid p-0 md:grid-cols-2">
              ...
              <div className="flex flex-col gap-6">
                <div className="flex flex-col items-center text-center">
                  ...
                  <p className="text-balance text-muted-foreground">
                    Ingresa a tu cuenta de la ferretería
                  </p>
                </div>
                ...
                <div className="grid grid-cols-3 gap-4">
                  <Button variant="outline" className="w-full" type="button">
                    ...
                    <span className="sr-only">Entrar con Apple</span>
                  </Button>
                  <Button variant="outline" className="w-full" type="button">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                      <path
                    ...
                    <span className="sr-only">Entrar con Google</span>
                  </Button>
                  <Button variant="outline" className="w-full" type="button">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                      <path
                    ...
                    <span className="sr-only">Entrar con Meta</span>
                  </Button>
                </div>
            ...
            <div className="relative hidden bg-muted md:block">
              <img
                src="https://images.unsplash.com/photo-1454165205744-3b78555e5572?q=80&w=1200&auto=format&fit=crop"
                alt="Imagen de fondo"

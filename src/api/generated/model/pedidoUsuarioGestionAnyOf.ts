 ...
 */
import type { PedidoUsuarioGestionAnyOfNombre } from "./pedidoUsuarioGestionAnyOfNombre";

export type PedidoUsuarioGestionAnyOf = {
  id: number;
  nombre: PedidoUsuarioGestionAnyOfNombre;
  email: string;
};

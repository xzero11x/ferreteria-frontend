 ...
 */
import type { PutApiProveedoresId400ErrorsItem } from "./putApiProveedoresId400ErrorsItem";

export type PutApiProveedoresId400 = {
  message: string;
  /** Lista de campos con errores */
  errors: PutApiProveedoresId400ErrorsItem[];
};

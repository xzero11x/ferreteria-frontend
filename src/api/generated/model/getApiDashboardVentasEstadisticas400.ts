 ...
 */
import type { GetApiDashboardVentasEstadisticas400ErrorsItem } from "./getApiDashboardVentasEstadisticas400ErrorsItem";

export type GetApiDashboardVentasEstadisticas400 = {
  message: string;
  /** Lista de campos con errores */
  errors: GetApiDashboardVentasEstadisticas400ErrorsItem[];
};

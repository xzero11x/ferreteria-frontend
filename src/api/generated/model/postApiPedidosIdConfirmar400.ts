 ...
 */
import type { PostApiPedidosIdConfirmar400ErrorsItem } from "./postApiPedidosIdConfirmar400ErrorsItem";

export type PostApiPedidosIdConfirmar400 = {
  message: string;
  /** Lista de campos con errores */
  errors: PostApiPedidosIdConfirmar400ErrorsItem[];
};

 ...
 */
import type { PostApiProveedores400ErrorsItem } from "./postApiProveedores400ErrorsItem";

export type PostApiProveedores400 = {
  message: string;
  /** Lista de campos con errores */
  errors: PostApiProveedores400ErrorsItem[];
};

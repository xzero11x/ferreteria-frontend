 ...
 */
import type { CreatePedidoDetallesItemCantidad } from "./createPedidoDetallesItemCantidad";

export type CreatePedidoDetallesItem = {
  /**
   * ID del producto a pedir
   */
  producto_id: number;
  /** Cantidad solicitada (máximo 3 decimales) */
  cantidad: CreatePedidoDetallesItemCantidad;
};

 ...
 */
import type { PostApiPedidosIdGenerarVenta400ErrorsItem } from "./postApiPedidosIdGenerarVenta400ErrorsItem";

export type PostApiPedidosIdGenerarVenta400 = {
  message: string;
  /** Lista de campos con errores */
  errors: PostApiPedidosIdGenerarVenta400ErrorsItem[];
};

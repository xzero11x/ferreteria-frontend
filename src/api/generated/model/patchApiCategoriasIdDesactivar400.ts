 ...
 */
import type { PatchApiCategoriasIdDesactivar400ErrorsItem } from "./patchApiCategoriasIdDesactivar400ErrorsItem";

export type PatchApiCategoriasIdDesactivar400 = {
  message: string;
  /** Lista de campos con errores */
  errors: PatchApiCategoriasIdDesactivar400ErrorsItem[];
};

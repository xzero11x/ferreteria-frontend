 ...
 */
import type { DeleteApiComprasId400ErrorsItem } from "./deleteApiComprasId400ErrorsItem";

export type DeleteApiComprasId400 = {
  message: string;
  /** Lista de campos con errores */
  errors: DeleteApiComprasId400ErrorsItem[];
};

 ...
 */
import type { PostApiMovimientosCaja400ErrorsItem } from "./postApiMovimientosCaja400ErrorsItem";

export type PostApiMovimientosCaja400 = {
  message: string;
  /** Lista de campos con errores */
  errors: PostApiMovimientosCaja400ErrorsItem[];
};

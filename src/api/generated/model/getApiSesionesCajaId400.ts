 ...
 */
import type { GetApiSesionesCajaId400ErrorsItem } from "./getApiSesionesCajaId400ErrorsItem";

export type GetApiSesionesCajaId400 = {
  message: string;
  /** Lista de campos con errores */
  errors: GetApiSesionesCajaId400ErrorsItem[];
};

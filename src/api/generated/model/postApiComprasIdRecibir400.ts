 ...
 */
import type { PostApiComprasIdRecibir400ErrorsItem } from "./postApiComprasIdRecibir400ErrorsItem";

export type PostApiComprasIdRecibir400 = {
  message: string;
  /** Lista de campos con errores */
  errors: PostApiComprasIdRecibir400ErrorsItem[];
};

 ...
 */
import type { GetApiUnidadesMedidaId400ErrorsItem } from "./getApiUnidadesMedidaId400ErrorsItem";

export type GetApiUnidadesMedidaId400 = {
  message: string;
  /** Lista de campos con errores */
  errors: GetApiUnidadesMedidaId400ErrorsItem[];
};

 ...
 */
import type { GetApiProveedoresId400ErrorsItem } from "./getApiProveedoresId400ErrorsItem";

export type GetApiProveedoresId400 = {
  message: string;
  /** Lista de campos con errores */
  errors: GetApiProveedoresId400ErrorsItem[];
};

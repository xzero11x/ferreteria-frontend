 ...
 */
import type { GetApiInventarioAjustes400ErrorsItem } from "./getApiInventarioAjustes400ErrorsItem";

export type GetApiInventarioAjustes400 = {
  message: string;
  /** Lista de campos con errores */
  errors: GetApiInventarioAjustes400ErrorsItem[];
};

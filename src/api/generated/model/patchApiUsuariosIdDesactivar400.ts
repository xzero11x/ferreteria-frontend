 ...
 */
import type { PatchApiUsuariosIdDesactivar400ErrorsItem } from "./patchApiUsuariosIdDesactivar400ErrorsItem";

export type PatchApiUsuariosIdDesactivar400 = {
  message: string;
  /** Lista de campos con errores */
  errors: PatchApiUsuariosIdDesactivar400ErrorsItem[];
};

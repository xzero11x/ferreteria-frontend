 ...
 */
import type { PatchApiProveedoresIdDesactivar400ErrorsItem } from "./patchApiProveedoresIdDesactivar400ErrorsItem";

export type PatchApiProveedoresIdDesactivar400 = {
  message: string;
  /** Lista de campos con errores */
  errors: PatchApiProveedoresIdDesactivar400ErrorsItem[];
};

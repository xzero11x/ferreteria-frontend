 ...
 */
import type { GetApiMovimientosCajaSesionActiva400ErrorsItem } from "./getApiMovimientosCajaSesionActiva400ErrorsItem";

export type GetApiMovimientosCajaSesionActiva400 = {
  message: string;
  /** Lista de campos con errores */
  errors: GetApiMovimientosCajaSesionActiva400ErrorsItem[];
};

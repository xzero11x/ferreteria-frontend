 ...
 */
import type { PatchApiTenantConfiguracionFiscal400ErrorsItem } from "./patchApiTenantConfiguracionFiscal400ErrorsItem";

export type PatchApiTenantConfiguracionFiscal400 = {
  message: string;
  /** Lista de campos con errores */
  errors: PatchApiTenantConfiguracionFiscal400ErrorsItem[];
};

...
import type { PaginatedUnidadMedidaResponseMeta } from "./paginatedUnidadMedidaResponseMeta";

export interface PaginatedUnidadMedidaResponse {
  data: UnidadMedida[];
  meta: PaginatedUnidadMedidaResponseMeta;
}

 ...
 */
import type { PatchApiClientesIdDesactivar400ErrorsItem } from "./patchApiClientesIdDesactivar400ErrorsItem";

export type PatchApiClientesIdDesactivar400 = {
  message: string;
  /** Lista de campos con errores */
  errors: PatchApiClientesIdDesactivar400ErrorsItem[];
};

...
/**
 * Estado inicial del pedido (siempre "pendiente")
 */
export type PedidoPublicoResponseEstado =
  (typeof PedidoPublicoResponseEstado)[keyof typeof PedidoPublicoResponseEstado];

// eslint-disable-next-line @typescript-eslint/no-redeclare
export const PedidoPublicoResponseEstado = {
  pendiente: "pendiente",
} as const;

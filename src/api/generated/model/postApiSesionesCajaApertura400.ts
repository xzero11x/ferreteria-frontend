 ...
 */
import type { PostApiSesionesCajaApertura400ErrorsItem } from "./postApiSesionesCajaApertura400ErrorsItem";

export type PostApiSesionesCajaApertura400 = {
  message: string;
  /** Lista de campos con errores */
  errors: PostApiSesionesCajaApertura400ErrorsItem[];
};

 ...
 */
import type { GetApiUnidadesMedida400ErrorsItem } from "./getApiUnidadesMedida400ErrorsItem";

export type GetApiUnidadesMedida400 = {
  message: string;
  /** Lista de campos con errores */
  errors: GetApiUnidadesMedida400ErrorsItem[];
};

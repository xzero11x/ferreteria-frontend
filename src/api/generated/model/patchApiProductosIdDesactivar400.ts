 ...
 */
import type { PatchApiProductosIdDesactivar400ErrorsItem } from "./patchApiProductosIdDesactivar400ErrorsItem";

export type PatchApiProductosIdDesactivar400 = {
  message: string;
  /** Lista de campos con errores */
  errors: PatchApiProductosIdDesactivar400ErrorsItem[];
};

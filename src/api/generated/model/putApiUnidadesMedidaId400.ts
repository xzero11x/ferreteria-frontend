 ...
 */
import type { PutApiUnidadesMedidaId400ErrorsItem } from "./putApiUnidadesMedidaId400ErrorsItem";

export type PutApiUnidadesMedidaId400 = {
  message: string;
  /** Lista de campos con errores */
  errors: PutApiUnidadesMedidaId400ErrorsItem[];
};

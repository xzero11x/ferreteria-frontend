 ...
 */
import type { AperturaSesionCajaMontoInicial } from "./aperturaSesionCajaMontoInicial";

export interface AperturaSesionCaja {
  /**
   * ID de la caja registradora
   */
  caja_id: number;
  /** Monto inicial en efectivo al abrir la caja (máximo 2 decimales) */
  monto_inicial: AperturaSesionCajaMontoInicial;
}

 ...
 */
import type { PutApiCategoriasId400ErrorsItem } from "./putApiCategoriasId400ErrorsItem";

export type PutApiCategoriasId400 = {
  message: string;
  /** Lista de campos con errores */
  errors: PutApiCategoriasId400ErrorsItem[];
};

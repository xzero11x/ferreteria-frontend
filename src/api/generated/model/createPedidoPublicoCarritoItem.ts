 ...
 */
import type { CreatePedidoPublicoCarritoItemCantidad } from "./createPedidoPublicoCarritoItemCantidad";

export type CreatePedidoPublicoCarritoItem = {
  /**
   * ID del producto a pedir
   */
  producto_id: number;
  /** Cantidad solicitada (máximo 3 decimales) */
  cantidad: CreatePedidoPublicoCarritoItemCantidad;
};

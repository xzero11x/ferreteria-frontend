 ...
 */
import type { GetApiMovimientosCajaSesionSesionId400ErrorsItem } from "./getApiMovimientosCajaSesionSesionId400ErrorsItem";

export type GetApiMovimientosCajaSesionSesionId400 = {
  message: string;
  /** Lista de campos con errores */
  errors: GetApiMovimientosCajaSesionSesionId400ErrorsItem[];
};

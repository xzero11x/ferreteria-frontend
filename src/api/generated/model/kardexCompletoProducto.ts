 ...
 */
import type { KardexCompletoProductoSku } from "./kardexCompletoProductoSku";

/**
 * Información básica del producto
 */
export type KardexCompletoProducto = {
  /** ID del producto */
  id: number;
  /** Nombre del producto */
  nombre: string;
  /** SKU del producto (puede ser null si no está asignado) */
  sku: KardexCompletoProductoSku;

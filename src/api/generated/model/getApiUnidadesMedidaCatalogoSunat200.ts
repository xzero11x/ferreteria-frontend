 ...
 */
import type { GetApiUnidadesMedidaCatalogoSunat200UnidadesItem } from "./getApiUnidadesMedidaCatalogoSunat200UnidadesItem";

export type GetApiUnidadesMedidaCatalogoSunat200 = {
  total: number;
  normativa: string;
  referencia: string;
  unidades: GetApiUnidadesMedidaCatalogoSunat200UnidadesItem[];
};

 ...
 */
import type { PedidoDetallesItemProducto } from "./pedidoDetallesItemProducto";

export type PedidoDetallesItem = {
  id: number;
  /** Cantidad solicitada (soporta decimales) */
  cantidad: number;
  tenant_id: number;
  pedido_id: number;
  producto_id: number;
  producto?: PedidoDetallesItemProducto;
};

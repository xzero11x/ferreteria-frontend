 ...
 */
import type { PostApiUnidadesMedida400ErrorsItem } from "./postApiUnidadesMedida400ErrorsItem";

export type PostApiUnidadesMedida400 = {
  message: string;
  /** Lista de campos con errores */
  errors: PostApiUnidadesMedida400ErrorsItem[];
};
